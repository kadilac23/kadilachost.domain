...
function(t) {
    function e(t, e, o) {
        var r = t[0],
            s = /er/.test(o) ? v : /bl/.test(o) ? f : d,
            a = o == m ? {
                checked: r[d],
                disabled: r[f],
                indeterminate: "true" == t.attr(v) || "false" == t.attr(g)
            } : r[s];
        if (/^(ch|di|in)/.test(o) && !a) i(t, s);
        else if (/^(un|en|de)/.test(o) && a) n(t, s);
        else if (o == m)
            for (var l in a) a[l] ? i(t, l, !0) : n(t, l, !0);
        else e && "toggle" != o || (e || t[S]("ifClicked"), a ? r[y] !== u && n(t, s) : i(t, s))
    }
    ...
    function i(e, i, o) {
        var p = e[0],
            ...
            x = r(e, i + s(p[y]));
        if (!0 !== p[i]) {
            if (!o && i == d && p[y] == u && p.name) {
                var k = e.closest("form"),
                    _ = 'input[name="' + p.name + '"]';
                _ = k.length ? k.find(_) : t(_), _.each(function() {
                    this !== p && t(this).data(l) && n(t(this), i)
                })
            }
            b ? (p[i] = !0, p[d] && n(e, d, "force")) : (o || (p[i] = !0), w && p[v] && n(e, v, !1)), a(e, w, i, o)
        }
        p[f] && r(e, T, !0) && m.find("." + c).css(T, "default"), m[C](x || r(e, i) || ""), m.attr("role") && !b && m.attr("aria-" + (S ? f : d), "true"), m[O](I || r(e, $) || "")
    }
    ...
    function n(t, e, i) {
        var n = t[0],
            ...
            w = r(t, m + s(n[y])),
            b = r(t, e + s(n[y]));
        !1 !== n[e] && (!p && i && "force" != i || (n[e] = !1), a(t, l, m, i)), !n[f] && r(t, T, !0) && o.find("." + c).css(T, "pointer"), o[O](b || r(t, e) || ""), o.attr("role") && !p && o.attr("aria-" + (u ? f : d), "false"), o[C](w || r(t, m) || "")
    }

    function o(e, i) {
        e.data(l) && (e.parent().html(e.attr("style", e.data(l).s || "")), i && e[S](i), e.off(".i").unwrap(), t($ + '[for="' + e[0].id + '"]').add(e.closest($)).off(".i"))
    }
    ...
    function a(t, e, i, n) {
        n || (e && t[S]("ifToggled"), t[S]("change")[S]("ifChanged")[S]("if" + s(i)))
    }
    var l = "iCheck",
        c = l + "-helper",
        p = "checkbox",
        ...
        $ = "label",
        T = "cursor",
        I = /ip(hone|od|ad)|android|blackberry|windows phone|opera mini|silk/i.test(navigator.userAgent) || "MacIntel" === navigator.platform && navigator.maxTouchPoints > 1;
    t.fn[l] = function(r, s) {
        var a = 'input[type="' + p + '"], input[type="' + u + '"]',
            h = t(),
            g = function(e) {
                e.each(function() {
                    var e = t(this);
                    h = e.is(a) ? h.add(e) : h.add(e.find(a))
                })
            };
        if (/^(check|uncheck|toggle|indeterminate|determinate|disable|enable|update|destroy)$/i.test(r)) return r = r.toLowerCase(), g(this), h.each(function() {
            var i = t(this);
            "destroy" == r ? o(i, "ifDestroyed") : e(i, !0, r), t.isFunction(s) && s()
        });
        ...
        var T = t.extend({
            ...
            _ = T.focusClass || "focus",
            P = T.activeClass || "active",
            A = !!T.labelHover,
            D = T.labelHoverClass || "hover",
            F = 0 | ("" + T.increaseArea).replace("%", "");
        return x != p && x != u || (a = 'input[type="' + x + '"]'), F < -50 && (F = -50), g(this), h.each(function() {
            var r = t(this);
            o(r);
            var s, a = this,
                h = a.id,
                ...
                z = a[y] == p ? T.checkboxClass || "i" + p : T.radioClass || "i" + u,
                q = t($ + '[for="' + h + '"]').add(r.closest($)),
                H = !!T.aria,
                N = l + "-" + Math.random().toString(36).substr(2, 6),
                L = '<div class="' + z + '" ' + (H ? 'role="' + a[y] + '" ' : "");
            H && q.each(function() {
                L += 'aria-labelledby="', this.id ? L += this.id : (this.id = N, L += N), L += '"'
            }), L = r.wrap(L + "/>")[S]("ifCreated").parent().append(T.insert), s = t('<ins class="' + c + '"/>').css(x).appendTo(L), r.data(l, {
                o: T,
                s: r.attr("style")
            }).css(E), T.inheritClass && L[C](a.className || ""), T.inheritID && h && L.attr("id", l + "-" + h), "static" == L.css("position") && L.css("position", "relative"), e(r, !0, m), q.length && q.on(w + ".i mouseover.i mouseout.i " + b, function(i) {
                var n = i[y],
                    o = t(this);
                if (!a[f]) {
                    if (n == w) {
                        ...
                        e(r, !1, !0)
                    } else A && (/ut|nd/.test(n) ? (L[O](k), o[O](D)) : (L[C](k), o[C](D)));
                    if (!I) return !1;
                    i.stopPropagation()
                }
            }), r.on(w + ".i focus.i blur.i keyup.i keydown.i keypress.i", function(t) {
                var e = t[y],
                    o = t.keyCode;
                return e != w && ("keydown" == e && 32 == o ? (a[y] == u && a[d] || (a[d] ? n(r, d) : i(r, d)), !1) : void("keyup" == e && a[y] == u ? !a[d] && i(r, d) : /us|ur/.test(e) && L["blur" == e ? O : C](_)))
            }), s.on(w + " mousedown mouseup mouseover mouseout " + b, function(t) {
                var i = t[y],
                    n = /wn|up/.test(i) ? P : k;
                if (!a[f]) {
                    if (i == w ? e(r, !1, !0) : (/wn|er|in/.test(i) ? L[C](n) : L[O](n + " " + P), q.length && A && n == k && q[/ut|nd/.test(i) ? O : C](D)), !I) return !1;
                    t.stopPropagation()
                }
            })
        })
            ...
            return function() {
                function n(t) {
                    ...
                    if (function(t, e) {
                        ...
                        }(this, n), this.options = n.extend(i, o), this.sidebar = "string" == typeof t ? document.querySelector(t) : t, void 0 === this.sidebar) throw new Error("There is no specific sidebar element.");
                ...
                return t(n, [{
                    ...
                    value: function() {
                        if (!this._breakpoint) {
                            ...
                            t.containerTop = n.offsetRelative(this.container).top, t.containerHeight = this.container.clientHeight, t.containerBottom = t.containerTop + t.containerHeight, t.sidebarHeight = this.sidebarInner.offsetHeight, t.sidebarWidth = this.sidebarInner.offsetWidth, t.viewportHeight = window.innerHeight, this._calcDimensionsWithScroll()
                        }
                    }
                }, {
                    ...
                    value: function(t) {
                        if (void 0 !== t) {
                            ...
                            return e.outer = n.extend({
                                height: "",
                                position: ""
                            }, e.outer), e.inner = n.extend({
                                position: "relative",
                                top: "",
                                left: "",
                                bottom: "",
                    ...
                    value: function(t) {
                        if (!this._breakpoint) {
                            ...
                            if ((this.affixedType != i || t) && i) {
                                var r = "affix." + i.toLowerCase().replace("viewport-", "") + e;
                                for (var s in n.eventTrigger(this.sidebar, r), "STATIC" === i ? n.removeClass(this.sidebar, this.options.stickyClass) : n.addClass(this.sidebar, this.options.stickyClass), o.outer) this.sidebar.style[s] = o.outer[s];
                ...
                if (t) {
                    t.fn.stickySidebar = function(n) {
                        return this.each(function() {
                            var o = t(this),
                                r = t(this).data(i);
                            if (r || (r = new e(this, "object" == typeof n && n), o.data(i, r)), "string" == typeof n) {
                                if (void 0 === r[n] && -1 === ["destroy", "updateSticky"].indexOf(n)) throw new Error('No method named "' + n + '"');
                                r[n]()
                            }
                        })
...
function(t, e) {
    ...
    t.prototype.tokenize = function(t) {
        if (t = o(String(t || "").toLowerCase()), !t || !t.length) return [];
        var e, i, n, s, l = [],
            c = t.split(/ +/);
        for (e = 0, i = c.length; e < i; e++) {
            if (n = r(c[e]), this.settings.diacritics)
        ...
        var i, o, r, s, a;
        i = this, t = i.prepareSearch(t, e), r = t.tokens, o = t.options.fields, s = r.length, a = t.options.nesting;
        var l = function(t, e) {
                var i, n;
                return t ? (t = String(t || ""), n = t.search(e.regex), -1 === n ? 0 : (i = e.string.length / t.length, 0 === n && (i += .5), i)) : 0
            },
            c = function() {
                var t = o.length;
                return t ? 1 === t ? function(t, e) {
                    return l(n(e, o[0], a), t)
                } : function(e, i) {
                    for (var r = 0, s = 0; r < t; r++) s += l(n(i, o[r], a), e);
                    return s / t
                } : function() {
                    return 0
                }
        ...
        return s ? 1 === s ? function(t) {
            ...
            for (var e, i = 0, n = 0; i < s; i++) {
                if (e = c(r[i], t), e <= 0) return 0;
                n += e
            }
            return n / s
        } : function(t) {
            for (var e = 0, i = 0; e < s; e++) i += c(r[e], t);
            return i / s
        } : function() {
            return 0
        }
    }, t.prototype.getSortFunction = function(t, i) {
        var o, r, s, a, l, c, p, u, d, h, f;
        if (s = this, t = s.prepareSearch(t, i), f = !t.query && i.sort_empty || i.sort, d = function(t, e) {
        ...
        if (t.query) {
            ...
            for (o = 0, r = l.length; o < r; o++)
                if ("$score" === l[o].field) {
                    l.splice(o, 1);
                    break
                } for (u = [], o = 0, r = l.length; o < r; o++) u.push("desc" === l[o].direction ? -1 : 1);
        return c = l.length, c ? 1 === c ? (a = l[0].field, p = u[0], function(t, i) {
            return p * e(d(a, t), d(a, i))
        }) : function(t, i) {
            var n, o, r;
            for (n = 0; n < c; n++)
                if (r = l[n].field, o = u[n] * e(d(r, t), d(r, i))) return o;
            return 0
        } : null
        ...
        var i, n, o, r, s = this;
        return n = this.prepareSearch(t, e), e = n.options, t = n.query, r = e.score || s.getScoreFunction(n), t.length ? s.iterator(s.items, function(t, o) {
            i = r(t), (!1 === e.filter || i > 0) && n.items.push({
                score: i,
                id: o
            })
        ...
        }), o = s.getSortFunction(n, e), o && n.items.sort(o), n.total = n.items.length, "number" == typeof e.limit && (n.items = n.items.slice(0, e.limit)), n
    };
    var e = function(t, e) {
        ...
        l = function() {
            ...
            for (i in a)
                if (a.hasOwnProperty(i))
                    for (n = a[i].substring(2, a[i].length - 1), o += n, t = 0, e = n.length; t < e; t++) r[n.charAt(t)] = i;
            ...
            mixin: function(t) {
                t.plugins = {}, t.prototype.initializePlugins = function(t) {
                    ...
                    if (r.plugins = {
                        ...
                        for (i = 0, n = t.length; i < n; i++) "string" == typeof t[i] ? s.push(t[i]) : (r.plugins.settings[t[i].name] = t[i].options, s.push(t[i].name));
                    else if (t)
...
function(t, e) {
    ...
    var r = /Mac/.test(navigator.userAgent),
        ...
        P = function(t, e, i) {
            ...
            for (n in t.trigger = function() {
                    var i = arguments[0];
                    return -1 === e.indexOf(i) ? o.apply(t, arguments) : void(r[i] = arguments)
        ...
        F = function(t, e, i) {
            var n, o, r = {};
            if (i)
                for (n = 0, o = i.length; n < o; n++) r[i[n]] = t.css(i[n]);
            else r = t.css();
            e.css(r)
        },
        E = function(e, i) {
        ...
        H = function(t, e) {
            e || (e = {});
            var i = "Selectize";
            console.error(i + ": " + t), e.explanation && (console.group && console.group(), console.error(e.explanation), console.group && console.groupEnd())
        },
        N = function(i, n) {
            var o, r, s, a, l = this;
            a = i[0], a.selectize = l;
            var c = window.getComputedStyle && window.getComputedStyle(a, null);
            if (s = c ? c.getPropertyValue("direction") : a.currentStyle && a.currentStyle.direction, s = s || i.parents("[dir]:first").attr("dir") || "", t.extend(l, {
                    order: 0,
                    settings: n,
                    $input: i,
                    tabIndex: i.attr("tabindex") || "",
                    tagType: "select" === a.tagName.toLowerCase() ? C : O,
                    rtl: /rtl/i.test(s),
                    ...
                    items: [],
                    renderCache: {},
                    onSearchChange: null === n.loadThrottle ? l.onSearchChange : _(l.onSearchChange, n.loadThrottle)
    ...
    return o.mixin(N), void 0 !== i ? i.mixin(N) : H("Dependency MicroPlugin is missing", {
        explanation: 'Make sure you either: (1) are using the "standalone" version of Selectize, or (2) require MicroPlugin before you load Selectize.'
    }), t.extend(N.prototype, {
        setup: function() {
            var e, i, n, o, s, a, l, c, p, u, d = this,
                h = d.settings,
                f = d.eventNS,
                g = t(window),
                v = t(document),
                b = d.$input;
            if (l = d.settings.mode, c = b.attr("class") || "", e = t("<div>").addClass(h.wrapperClass).addClass(c).addClass(l), i = t("<div>").addClass(h.inputClass).addClass("items").appendTo(e), n = t('<input type="text" autocomplete="off" />').appendTo(i).attr("tabindex", b.is(":disabled") ? "-1" : d.tabIndex), a = t(h.dropdownParent || e), o = t("<div>").addClass(h.dropdownClass).addClass(l).hide().appendTo(a), s = t("<div>").addClass(h.dropdownContentClass).appendTo(o), (u = b.attr("id")) && (n.attr("id", u + "-selectized"), t("label[for='" + u + "']").attr("for", u + "-selectized")), d.settings.copyClassesToDropdown && o.addClass(c), e.css({
                    width: b[0].style.width
                }), d.plugins.names.length && (p = "plugin-" + d.plugins.names.join(" plugin-"), e.addClass(p), o.addClass(p)), (null === h.maxItems || h.maxItems > 1) && d.tagType === C && b.attr("multiple", "multiple"), d.settings.placeholder && n.attr("placeholder", h.placeholder), !d.settings.splitOn && d.settings.delimiter) {
                var O = d.settings.delimiter.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&");
                d.settings.splitOn = new RegExp("\\s*" + O + "+\\s*")
            }
            b.attr("autocorrect") && n.attr("autocorrect", b.attr("autocorrect")), b.attr("autocapitalize") && n.attr("autocapitalize", b.attr("autocapitalize")), d.$wrapper = e, d.$control = i, d.$control_input = n, d.$dropdown = o, d.$dropdown_content = s, o.on("mouseenter", "[data-selectable]", function() {
            ...
            }), A(i, "mousedown", "*:not(input)", function() {
            ...
            }), v.on("keydown" + f, function(t) {
                d.isCmdDown = t[r ? "metaKey" : "ctrlKey"], d.isCtrlDown = t[r ? "altKey" : "ctrlKey"], d.isShiftDown = t.shiftKey
            }), v.on("keyup" + f, function(t) {
                t.keyCode === w && (d.isCtrlDown = !1), t.keyCode === m && (d.isShiftDown = !1), t.keyCode === y && (d.isCmdDown = !1)
            }), v.on("mousedown" + f, function(t) {
                if (d.isFocused) {
            ...
            }, b.attr("tabindex", -1).hide().after(d.$wrapper), t.isArray(h.items) && (d.setValue(h.items), delete h.items), S && b.on("invalid" + f, function(t) {
                t.preventDefault(), d.isInvalid = !0, d.refreshState()
            }), d.updateOriginalInput(), d.refreshItems(), d.refreshState(), d.updatePlaceholder(), d.isSetup = !0, b.is(":disabled") && d.disable(), d.on("change", this.onChange), b.data("selectize", d), b.addClass("selectized"), d.trigger("initialize"), !0 === h.preload && d.onSearchChange("")
        },
        ...
        onPaste: function(e) {
            ...
            return i.isFull() || i.isInputHidden || i.isLocked ? void e.preventDefault() : void(i.settings.splitOn && setTimeout(function() {
                ...
                if (e.match(i.settings.splitOn))
                    for (var n = t.trim(e).split(i.settings.splitOn), o = 0, r = n.length; o < r; o++) i.createItem(n[o])
            }, 0))
        },
        ...
        onOptionSelect: function(e) {
            ...
            }) : (i = n.attr("data-value"), void 0 !== i && (o.lastQuery = null, o.setTextboxValue(""), o.addItem(i), o.settings.closeAfterSelect ? o.close() : !o.settings.hideSelected && e.type && /mouse/.test(e.type) && o.setActiveOption(o.getOption(i))))
        },
        ...
        setActiveItem: function(e, i) {
            ...
            if ("single" !== u.settings.mode) {
                ...
                if (n = i && i.type.toLowerCase(), "mousedown" === n && u.isShiftDown && u.$activeItems.length) {
                    for (p = u.$control.children(".active:last"), s = Array.prototype.indexOf.apply(u.$control[0].childNodes, [p[0]]), a = Array.prototype.indexOf.apply(u.$control[0].childNodes, [e[0]]), s > a && (c = s, s = a, a = c), o = s; o <= a; o++) l = u.$control[0].childNodes[o], -1 === u.$activeItems.indexOf(l) && (t(l).addClass("active"), u.$activeItems.push(l));
                    i.preventDefault()
                } else "mousedown" === n && u.isCtrlDown || "keydown" === n && this.isShiftDown ? e.hasClass("active") ? (r = u.$activeItems.indexOf(e[0]), u.$activeItems.splice(r, 1), e.removeClass("active")) : u.$activeItems.push(e.addClass("active")[0]) : (t(u.$activeItems).removeClass("active"), u.$activeItems = [e.addClass("active")[0]]);
                u.hideInput(), this.isFocused || u.focus()
            }
        },
        setActiveOption: function(e, i, n) {
            var o, r, s, a, l, c = this;
            c.$activeOption && c.$activeOption.removeClass("active"), c.$activeOption = null, e = t(e), e.length && (c.$activeOption = e.addClass("active"), !i && $(i) || (o = c.$dropdown_content.height(), r = c.$activeOption.outerHeight(!0), i = c.$dropdown_content.scrollTop() || 0, s = c.$activeOption.offset().top - c.$dropdown_content.offset().top + i, a = s, l = s - o + r, s + r > o + i ? c.$dropdown_content.stop().animate({
                scrollTop: l
        ...
        search: function(e) {
            ...
            if (e !== r.lastQuery ? (r.lastQuery = e, n = r.sifter.search(e, t.extend(a, {
                    score: o
                })), r.currentResults = n) : n = t.extend(!0, {}, r.currentResults), s.hideSelected)
                for (i = n.items.length - 1; i >= 0; i--) - 1 !== r.items.indexOf(T(n.items[i].id)) && n.items.splice(i, 1);
            return n
        },
        refreshOptions: function(e) {
            var i, o, r, s, a, l, c, p, u, d, h, f, g, v, m, y;
            void 0 === e && (e = !0);
            var w = this,
                b = t.trim(w.$control_input.val()),
                C = w.search(b),
                O = w.$dropdown_content,
                S = w.$activeOption && T(w.$activeOption.attr("data-value"));
            for (s = C.items.length, "number" == typeof w.settings.maxOptions && (s = Math.min(s, w.settings.maxOptions)), a = {}, l = [], i = 0; i < s; i++)
                for (c = w.options[C.items[i].id], p = w.render("option", c), u = c[w.settings.optgroupField] || "", d = t.isArray(u) ? u : [u], o = 0, r = d && d.length; o < r; o++) u = d[o], w.optgroups.hasOwnProperty(u) || (u = ""), a.hasOwnProperty(u) || (a[u] = document.createDocumentFragment(), l.push(u)), a[u].appendChild(p);
            for (this.settings.lockOptgroupOrder && l.sort(function(t, e) {
                    var i = w.optgroups[t].$order || 0,
                        n = w.optgroups[e].$order || 0;
                    return i - n
                }), h = document.createDocumentFragment(), i = 0, s = l.length; i < s; i++) u = l[i], w.optgroups.hasOwnProperty(u) && a[u].childNodes.length ? (f = document.createDocumentFragment(), f.appendChild(w.render("optgroup_header", w.optgroups[u])), f.appendChild(a[u]), h.appendChild(w.render("optgroup", t.extend({}, w.optgroups[u], {
                html: q(f),
                dom: f
            })))) : h.appendChild(a[u]);
            if (O.html(h), w.settings.highlight && C.query.length && C.tokens.length)
                for (O.removeHighlight(), i = 0, s = C.tokens.length; i < s; i++) n(O, C.tokens[i].regex);
            if (!w.settings.hideSelected)
                for (i = 0, s = w.items.length; i < s; i++) w.getOption(w.items[i]).addClass("selected");
            g = w.canCreate(b), g && (O.prepend(w.render("option_create", {
                input: b
            })), y = t(O[0].childNodes[0])), w.hasOptions = C.items.length > 0 || g, w.hasOptions ? (C.items.length > 0 ? (m = S && w.getOption(S), m && m.length ? v = m : "single" === w.settings.mode && w.items.length && (v = w.getOption(w.items[0])), v && v.length || (v = y && !w.settings.addPrecedence ? w.getAdjacentOption(y, 1) : O.find("[data-selectable]:first"))) : v = y, w.setActiveOption(v), e && !w.isOpen && w.open()) : (w.setActiveOption(null), e && w.isOpen && w.close())
        },
        addOption: function(e) {
            var i, n, o, r = this;
            if (t.isArray(e))
                for (i = 0, n = e.length; i < n; i++) r.addOption(e[i]);
        ...
        updateOption: function(e, i) {
            var n, o, r, s, a, l, c, p = this;
            if (e = T(e), r = T(i[p.settings.valueField]), null !== e && p.options.hasOwnProperty(e)) {
                if ("string" != typeof r) throw new Error("Value must be set in option data");
                c = p.options[e].$order, r !== e && (delete p.options[e], s = p.items.indexOf(e), -1 !== s && p.items.splice(s, 1, r)), i.$order = i.$order || c, p.options[r] = i, a = p.renderCache.item, l = p.renderCache.option, a && (delete a[e], delete a[r]), l && (delete l[e], delete l[r]), -1 !== p.items.indexOf(r) && (n = p.getItem(e), o = t(p.render("item", i)), n.hasClass("active") && o.addClass("active"), n.replaceWith(o)), p.lastQuery = null, p.isOpen && p.refreshOptions(!1)
            }
        },
        ...
        removeItem: function(e, i) {
            var n, o, r, s = this;
            n = e instanceof t ? e : s.getItem(e), e = T(n.attr("data-value")), o = s.items.indexOf(e), -1 !== o && (n.remove(), n.hasClass("active") && (r = s.$activeItems.indexOf(n[0]), s.$activeItems.splice(r, 1)), s.items.splice(o, 1), s.lastQuery = null, !s.settings.persist && s.userOptions.hasOwnProperty(e) && s.removeOption(e, i), o < s.caretPos && s.setCaret(s.caretPos - 1), s.refreshState(), s.updatePlaceholder(), s.updateOriginalInput({
                silent: i
        ...
        createItem: function(e, i) {
            ...
            if ("function" != typeof r && (r = function() {}), "boolean" != typeof i && (i = !0), !n.canCreate(e)) return r(), !1;
            n.lock();
            var s = "function" == typeof n.settings.create ? this.settings.create : function(t) {
                ...
                a = k(function(t) {
                    ...
                    var e = T(t[n.settings.valueField]);
                    return "string" != typeof e ? r() : (n.setTextboxValue(""), n.addOption(t), n.setCaret(o), n.addItem(e), n.refreshOptions(i && "single" !== n.settings.mode), void r(t))
                }),
                l = s.apply(this, [e, a]);
        ...
        updateOriginalInput: function(t) {
            var e, i, n, o, r = this;
            if (t = t || {}, r.tagType === C) {
                for (n = [], e = 0, i = r.items.length; e < i; e++) o = r.options[r.items[e]][r.settings.labelField] || "", n.push('<option value="' + I(r.items[e]) + '" selected="selected">' + I(o) + "</option>");
        ...
        deleteSelection: function(e) {
            var i, n, o, r, s, a, l, c, p, u = this;
            if (o = e && e.keyCode === g ? -1 : 1, r = D(u.$control_input[0]), u.$activeOption && !u.settings.hideSelected && (l = u.getAdjacentOption(u.$activeOption, -1).attr("data-value")), s = [], u.$activeItems.length) {
                for (p = u.$control.children(".active:" + (o > 0 ? "last" : "first")), a = u.$control.children(":not(input)").index(p), o > 0 && a++, i = 0, n = u.$activeItems.length; i < n; i++) s.push(t(u.$activeItems[i]).attr("data-value"));
                e && (e.preventDefault(), e.stopPropagation())
            } else(u.isFocused || "single" === u.settings.mode) && u.items.length && (o < 0 && 0 === r.start && 0 === r.length ? s.push(u.items[u.caretPos - 1]) : o > 0 && r.start === u.$control_input.val().length && s.push(u.items[u.caretPos]));
            if (!s.length || "function" == typeof u.settings.onDelete && !1 === u.settings.onDelete.apply(u, [s])) return !1;
            for (void 0 !== a && u.setCaret(a); s.length;) u.removeItem(s.pop());
        ...
        advanceSelection: function(t, e) {
            ...
            0 !== t && (l.rtl && (t *= -1), i = t > 0 ? "last" : "first", n = D(l.$control_input[0]), l.isFocused && !l.isInputHidden ? (r = l.$control_input.val().length, s = t < 0 ? 0 === n.start && 0 === n.length : n.start === r, s && !r && l.advanceCaret(t, e)) : (a = l.$control.children(".active:" + i), a.length && (o = l.$control.children(":not(input)").index(a), l.setActiveItem(null), l.setCaret(t > 0 ? o + 1 : o))))
        },
        ...
        setCaret: function(e) {
            ...
            if (e = "single" === s.settings.mode ? s.items.length : Math.max(0, Math.min(s.items.length, e)), !s.isPending)
                for (o = s.$control.children(":not(input)"), i = 0, n = o.length; i < n; i++) r = t(o[i]).detach(), i < e ? s.$control_input.before(r) : s.$control.append(r);
            s.caretPos = e
        },
        lock: function() {
        ...
        render: function(e, i) {
            var n, o, r = "",
                s = !1,
                a = this;
            return "option" !== e && "item" !== e || (n = T(i[a.settings.valueField]), s = !!n), s && ($(a.renderCache[e]) || (a.renderCache[e] = {}), a.renderCache[e].hasOwnProperty(n)) ? a.renderCache[e][n] : (r = t(a.settings.render[e].apply(this, [i, I])), "option" === e || "option_create" === e ? r.attr("data-selectable", "") : "optgroup" === e && (o = i[a.settings.optgroupValueField] || "", r.attr("data-group", o)), "option" !== e && "item" !== e || r.attr("data-value", n || ""), s && (a.renderCache[e][n] = r[0]), r[0])
        },
        ...
        var i = t.fn.selectize.defaults,
            ...
            p = function(e, i) {
                var a, l, c, p, u = e.attr(o);
                if (u)
                    for (i.options = JSON.parse(u), a = 0, l = i.options.length; a < l; a++) i.items.push(i.options[a][s]);
                else {
                    var d = t.trim(e.val() || "");
                    if (!n.allowEmptyOption && !d.length) return;
                    for (c = d.split(n.delimiter), a = 0, l = c.length; a < l; a++) p = {}, p[r] = c[a], p[s] = c[a], i.options.push(p);
                    i.items = c
                }
            },
            u = function(e, i) {
                var p, u, d, h, f = i.options,
                    g = {},
                    v = function(t) {
                        var e = o && t.attr(o);
                    ...
                    m = function(e, o) {
                        ...
                        if (l || n.allowEmptyOption)
                            if (g.hasOwnProperty(l)) {
                                ...
                                var p = v(e) || {};
                                p[r] = p[r] || e.text(), p[s] = p[s] || l, p[a] = p[a] || o, g[l] = p, f.push(p), e.is(":selected") && i.items.push(l)
                            }
                    },
                    y = function(e) {
                        var n, o, r, s, a;
                        for (e = t(e), r = e.attr("label"), r && (s = v(e) || {}, s[l] = r, s[c] = r, i.optgroups.push(s)), a = t("option", e), n = 0, o = a.length; n < o; n++) m(a[n], r)
                    };
                for (i.maxItems = e.attr("multiple") ? null : 1, h = e.children(), p = 0, u = h.length; p < u; p++) d = h[p].tagName.toLowerCase(), "optgroup" === d ? y(h[p]) : "option" === d && m(h[p])
            };
        return this.each(function() {
            if (!this.selectize) {
                var o = t(this),
                ...
                "select" === r ? u(o, a) : p(o, a), new N(o, t.extend(!0, {}, i, a, e))
            }
        })
        ...
        var n = function() {
                var t, e = n.width,
                    i = document;
                return void 0 === e && (t = i.createElement("div"), t.innerHTML = '<div style="width:50px;height:50px;position:absolute;left:-50px;top:-50px;overflow:auto;"><div style="width:1px;height:100px;"></div></div>', t = t.firstChild, i.body.appendChild(t), e = n.width = t.offsetWidth - t.clientWidth, i.body.removeChild(t)), e
            },
            o = function() {
                var o, r, s, a, l, c, p;
                if (p = t("[data-group]", i.$dropdown_content), r = p.length, r && i.$dropdown_content.width()) {
                    if (e.equalizeHeight) {
                        for (s = 0, o = 0; o < r; o++) s = Math.max(s, p.eq(o).height());
                        p.css({
                            height: s
                        })
                    }
                    e.equalizeWidth && (c = i.$dropdown_content.innerWidth() - n(), a = Math.round(c / r), p.css({
                        width: a
                    }), r > 1 && (l = c - a * (r - 1), p.eq(r - 1).css({
                        width: l
                    })))
                }
            };
        (e.equalizeHeight || e.equalizeWidth) && (x.after(this, "positionDropdown", o), x.after(this, "refreshOptions", o))
        ...
        var i = function(e, i) {
                ...
                var n, o = e,
                    r = '<a href="javascript:void(0)" class="' + i.className + '" tabindex="-1" title="' + I(i.title) + '">' + i.label + "</a>",
                    s = function(t, e) {
                        return t + e
                    };
        ...
        return "single" === this.settings.mode ? void i(this, e) : void n(this, e)
        ...
        t.text = t.text || function(t) {
            ...
            var n, o;
            return i.keyCode === g && "" === this.$control_input.val() && !this.$activeItems.length && (n = this.caretPos - 1, n >= 0 && n < this.items.length) ? (o = this.options[this.items[n]], this.deleteSelection(i) && (this.setTextboxValue(t.text.apply(this, [o])), this.refreshOptions(!0)), void i.preventDefault()) : e.apply(this, arguments)
        })
    }), N
}),
function(t) {
    t.fn.hoverIntent = function(e, i, n) {
        ...
        var c = function(t) {
            ...
            p = function(e, i) {
                if (i.hoverIntent_t = clearTimeout(i.hoverIntent_t), Math.abs(s - o) + Math.abs(a - r) < l.sensitivity) return t(i).off("mousemove.hoverIntent", c), i.hoverIntent_s = 1, l.over.apply(i, [e]);
                s = o, a = r, i.hoverIntent_t = setTimeout(function() {
                    p(e, i)
                }, l.interval)
            },
            u = function(t, e) {
                return e.hoverIntent_t = clearTimeout(e.hoverIntent_t), e.hoverIntent_s = 0, l.out.apply(e, [t])
            },
            d = function(e) {
                var i = jQuery.extend({}, e),
                    n = this;
                n.hoverIntent_t && (n.hoverIntent_t = clearTimeout(n.hoverIntent_t)), "mouseenter" == e.type ? (s = i.pageX, a = i.pageY, t(n).on("mousemove.hoverIntent", c), 1 != n.hoverIntent_s && (n.hoverIntent_t = setTimeout(function() {
                    p(i, n)
...
function(t, e) {
    "use strict";
    var i, n, o, r, s, a, l, c, p, u, d, h, f, g, v, m, y = (n = {
    ...
    }(), i = document.documentElement.style, r = "behavior" in i && "fill" in i && /iemobile/i.test(navigator.userAgent), s = !!e.PointerEvent, a = function(t, e, i) {
        var o, r = n.menuClass;
        e.cssArrows && (r += " " + n.menuArrowClass), o = i ? "addClass" : "removeClass", t[o](r)
    }, l = function(e, i) {
        ...
        return u(t).data("sfOptions")
    }, h = function() {
        var e = t(this),
            i = d(e);
        clearTimeout(i.sfTimer), e.siblings().superfish("hide").end().superfish("show")
    }, f = function(e) {
        e.retainPath = t.inArray(this[0], e.$path) > -1, this.superfish("hide"), this.parents("." + e.hoverClass).length || (e.onIdle.call(u(this)), e.$path.length && t.proxy(h, e.$path)())
    }, g = function() {
        var e = t(this),
            i = d(e);
        ...
        o.length > 0 && o.is(":hidden") && (i.one("click.superfish", !1), "MSPointerDown" === e.type || "pointerdown" === e.type ? i.trigger("focus") : t.proxy(h, i.parent("li"))())
    }, m = function(e, i) {
        var n = "li:has(" + i.popUpSelector + ")";
        t.fn.hoverIntent && !i.disableHI ? e.hoverIntent(h, g, n) : e.on("mouseenter.superfish", n, h).on("mouseleave.superfish", n, g);
        var a = "MSPointerDown.superfish";
        s && (a = "pointerdown.superfish"), o || (a += " touchend.superfish"), r && (a += " mousedown.superfish"), e.on("focusin.superfish", "li", h).on("focusout.superfish", "li", g).on(a, "a", i, v)
    }, {
        hide: function(e) {
            if (this.length) {
                var i = this,
                ...
                var o = !0 === n.retainPath ? n.$path : "",
                    ...
                    s = n.speedOut;
                if (e && (r.show(), s = 0), n.retainPath = !1, !1 === n.onBeforeHide.call(r)) return this;
                r.stop(!0, !0).animate(n.animationOut, s, function() {
                    var e = t(this);
                    n.onHide.call(e)
                })
            }
        ...
        destroy: function() {
            return this.each(function() {
                var e, i = t(this),
                    o = i.data("sfOptions");
                if (!o) return !1;
                e = i.find(o.popUpSelector).parent("li"), clearTimeout(o.sfTimer), a(i, o), c(e), p(i), i.off(".superfish").off(".hoverIntent"), e.children(o.popUpSelector).attr("style", function(t, e) {
                    if (void 0 !== e) return e.replace(/display[^;]+;?/g, "")
                }), o.$path.removeClass(o.hoverClass + " " + n.bcClass).addClass(o.pathClass), i.find("." + o.hoverClass).removeClass(o.hoverClass), o.onDestroy.call(i), i.removeData("sfOptions")
            })
        },
        init: function(e) {
            return this.each(function() {
                ...
                o.$path = l(i, o), i.data("sfOptions", o), a(i, o, !0), c(r, !0), p(i), m(i, o), r.not("." + n.bcClass).superfish("hide", !0), o.onInit.call(this)
            })
        }
    });
